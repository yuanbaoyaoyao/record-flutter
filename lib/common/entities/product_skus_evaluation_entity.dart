...
ProductSkusEvaluationEntity productSkusEvaluationEntityFromJson(String str) =>
    ProductSkusEvaluationEntity.fromJson(json.decode(str));

String productSkusEvaluationEntityToJson(ProductSkusEvaluationEntity data) =>
...
class ProductSkusEvaluationEntity {
  ...
  factory ProductSkusEvaluationEntity.fromJson(Map<String, dynamic> json) =>
      ProductSkusEvaluationEntity(
        code: json["code"],
