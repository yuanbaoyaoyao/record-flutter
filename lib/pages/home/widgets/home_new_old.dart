                  ...
                  Visibility(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("剩余${state.oldProducts[0].stock}个")
                      ],
                    ),
                  ),
                  Visibility(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("剩余${state.oldProducts[1].stock}个")
                      ],
                    ),
                  ),
                  Visibility(
                    visible: textTitle == "新耗材",
                    child: Column(
                      children: [
                        Image.network(
                        ...
                        Text("剩余${state.newProducts[0].stock}个")
                      ],
                    ),
                  ),
                  Visibility(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("剩余${state.newProducts[1].stock}个")
                      ],
                    ),
                  ),
                ],
